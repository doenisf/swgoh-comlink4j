...
public class SkillType extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SkillType.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SkillType' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SkillType>() {
                @Override
                ...
                public SkillType read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for SkillType: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to SkillType
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for SkillType with oneOf schemas: Integer, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of SkillType given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of SkillType
     * @throws IOException if the JSON string is invalid with respect to SkillType
     */
    public static SkillType fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, SkillType.class);
    }

    /**
     * Convert an instance of SkillType to an JSON string
     *
     * @return JSON string
     */
