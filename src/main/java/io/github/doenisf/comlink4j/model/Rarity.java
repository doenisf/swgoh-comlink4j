...
public class Rarity extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!Rarity.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'Rarity' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<Rarity>() {
                @Override
                ...
                public Rarity read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        Rarity ret = new Rarity();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for Rarity: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to Rarity
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for Rarity with oneOf schemas: Integer, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of Rarity given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of Rarity
     * @throws IOException if the JSON string is invalid with respect to Rarity
     */
    public static Rarity fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, Rarity.class);
    }

    /**
     * Convert an instance of Rarity to an JSON string
     *
     * @return JSON string
     */
