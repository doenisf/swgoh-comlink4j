...
public class Category {
  ...
  public static final String SERIALIZED_NAME_UI_FILTER = "uiFilter";
  @SerializedName(SERIALIZED_NAME_UI_FILTER)
  private List<CombatType> uiFilter = new ArrayList<>();
  ...
  public Category descKey(String descKey) {
  ...
  public Category uiFilter(List<CombatType> uiFilter) {
    this.uiFilter = uiFilter;
    return this;
  }

  public Category addUiFilterItem(CombatType uiFilterItem) {
    if (this.uiFilter == null) {
      this.uiFilter = new ArrayList<>();
    }
    this.uiFilter.add(uiFilterItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public List<CombatType> getUiFilter() {
    return uiFilter;
  }

  public void setUiFilter(List<CombatType> uiFilter) {
    this.uiFilter = uiFilter;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, category.id) &&
        Objects.equals(this.descKey, category.descKey) &&
        Objects.equals(this.visible, category.visible) &&
        Objects.equals(this.uiFilter, category.uiFilter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, descKey, visible, uiFilter);
  }
  ...
  public String toString() {
    ...
    sb.append("    uiFilter: ").append(toIndentedString(uiFilter)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("uiFilter") != null && !jsonObj.get("uiFilter").isJsonNull()) {
        JsonArray jsonArrayuiFilter = jsonObj.getAsJsonArray("uiFilter");
        if (jsonArrayuiFilter != null) {
          // ensure the json data is an array
          if (!jsonObj.get("uiFilter").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `uiFilter` to be an array in the JSON string but got `%s`", jsonObj.get("uiFilter").toString()));
          }

          // validate the optional field `uiFilter` (array)
          for (int i = 0; i < jsonArrayuiFilter.size(); i++) {
            CombatType.validateJsonElement(jsonArrayuiFilter.get(i));
          };
        }
      }
  }
