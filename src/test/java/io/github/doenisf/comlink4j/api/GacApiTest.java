...
/**
 * API tests for GacApi
 */
@Disabled
public class GacApiTest {

    private final GacApi api = new GacApi();
    ...
    public void getLeaderboardTest() throws ApiException {
        ...
        GetLeaderboard2XXResponse response = api.getLeaderboard(getLeaderboardRequest);
